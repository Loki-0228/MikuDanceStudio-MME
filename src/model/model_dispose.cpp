...
// ---------------------------------------------------------------------------
// VA 0x0040A710 - Sub40A710(model, freeFlag): the dispose-and-maybe-free
// wrapper used by the model-delete command (0x47FEF1).  Returns the model
// pointer in the original; no caller reads it, kept void.
// ---------------------------------------------------------------------------
void Sub40A710(unsigned char* model, int freeFlag) {
