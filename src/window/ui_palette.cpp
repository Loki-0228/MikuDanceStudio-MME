...
void HandlePaletteChanged(HDC hdc) {
    ...
    RECT rc;
    GetClientRect(reinterpret_cast<HWND>(app->raw<void*>(offsets::kPtrHwnd)),
    ...
    if (app->raw<std::uint8_t>(offsets::kByteOptflag0) != 0) {   // 0x2F8
        if (app->raw<std::uint8_t>(offsets::kByteOptflag1) != 0) {  // 0x2F9
    ...
    } else if (app->raw<std::uint8_t>(offsets::kByteOptflag4) != 0) {  // 0x2FC
    ...
    if (app->raw<std::uint8_t>(offsets::kByteOptflag0) != 0) {   // 0x2F8
        if (app->raw<std::uint8_t>(offsets::kByteOptflag2) != 0) {  // 0x2FA
    ...
    } else if (app->raw<std::uint8_t>(offsets::kByteOptflag5) != 0) {  // 0x2FD
    ...
    if (app->raw<std::uint8_t>(offsets::kByteOptflag0) != 0) {   // 0x2F8
        ...
        if (app->raw<std::uint8_t>(offsets::kByteOptflag6) != 0) {  // 0x2FE
    ...
    if (app->raw<std::uint8_t>(offsets::kByteOptflag0) != 0) {   // 0x2F8
        ...
        if (app->raw<std::uint8_t>(offsets::kByteOptflag3) != 0) {  // 0x2FB
...
void HandlePaletteChanged2(HDC hdc) {
    ...
    if (hwnd != nullptr) {
        ...
        hwnd = reinterpret_cast<HWND>(app->raw<void*>(offsets::kPtrHwnd));  // 0xA06B8
        GetClientRect(hwnd, &rc);
    ...
    if (app->raw<std::uint8_t>(offsets::kByteOptflag0) != 0) {   // 0x2F8: camera/light mode
